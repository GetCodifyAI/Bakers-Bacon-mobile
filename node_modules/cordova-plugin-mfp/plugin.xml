...
<plugin id="cordova-plugin-mfp" version="8.0.2023071003" xmlns="http://apache.org/cordova/ns/plugins/1.0">
    ...
    <engines>
        <engine name="cordova-android" version="&gt;=6.1.2 &lt;12" />
        <engine name="cordova-ios" version="&gt;=4.1.1 &lt;7" />
        <engine name="cordova-windows" version="&gt;=4.3.2 &lt;8" />
        <engine name="cordova-plugman" version="&gt;=6.1.1 &lt;12" />
    </engines>
