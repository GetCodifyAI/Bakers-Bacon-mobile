...
function IOSAfterPrepare(projectDirectory) {
    ...
    function addEmbeddedMfpFrameworks(){
        ...
        try {
            ...
            appProj.removeFramework(path.join(projName, 'Plugins', 'cordova-plugin-mfp', 'IBMMobileFirstPlatformFoundationHybrid.xcframework'), {customFramework: true});
            appProj.addFramework(path.join(projName, 'Plugins', 'cordova-plugin-mfp', 'IBMMobileFirstPlatformFoundationHybrid.xcframework'), {customFramework: true});
